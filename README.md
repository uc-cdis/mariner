...
That is, how will users access the engine workspace, which are all
files with a particular prefix in the engine workspace bucket?
2. What functionality/endpoints (in addition to the WES API) should the mariner API have?  
